<template>
  <header v-if="!props.loading && props"
    ...
    <div class="flex items-center">
      <img v-if="props.profileUrl" :src="props.profileUrl" class="w-10 h-10 rounded-full object-cover" alt="프로필" />
    ...
    <div class="z-30 relative">
      ...
      <div v-if="isMenuOpen"
        ...
        <div class="text-sm bg-white p-4 rounded-md shadow-md flex flex-col">
          <button v-if="props.userType !== 'SELLER'" @click="handleChangeProductStatus" :data-type="'SOLDOUT'">
    ...
    <CommonModal :isVisible="isReviewModalOpen" @close="closeReviewModal">
      <ReviewForm @submit="submitReview" :reviewType="'PRODUCT'" :email="userEmail" :productId="props.productId"/>
    </CommonModal>
  </header>
</template>
