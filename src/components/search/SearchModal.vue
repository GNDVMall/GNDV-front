  ...
  <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white w-full h-full p-8 relative overflow-y-auto">
      ...
      <div class="flex flex-col items-center mb-8">
        <input type="text" v-model="searchKeyword" @keyup.enter="searchItems" class="w-full max-w-3xl py-4 border-b border-gray-300 focus:outline-none text-2xl" placeholder="브랜드, 상품, 프로필, 태그 등">
      </div>
