...
const fetchReviewDetail = async () => {
  try {
    ...
    review_content.value = response.data.data.review_content;
    review_rating.value = response.data.data.review_rating;
  } catch (error) {
...
const submitForm = async () => {
  ...
  const review = {
    ...
    order_list_id: props.orderListId, // 변경된 부분: orderListId가 props로부터 오도록 수정
  };
